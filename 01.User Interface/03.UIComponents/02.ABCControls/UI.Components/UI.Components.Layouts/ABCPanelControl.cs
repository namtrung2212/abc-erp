...
namespace ABCControls
{
    ...
    [Designer( typeof( ABCPanelControlDesigner ) )]
    public class ABCPanelControl : DevExpress.XtraEditors.PanelControl , IABCControl 
    {
    ...
    public class ABCPanelControlDesigner : System.Windows.Forms.Design.ScrollableControlDesigner
    {
        public ABCPanelControlDesigner ( )
        {
        }
    }
}
