...
{
    [ToolboxBitmapAttribute( typeof( DevExpress.XtraEditors.TimeEdit ) )]
    [Designer( typeof( ABCTimeEditDesigner ) )]
    public class ABCTimeEdit : DevExpress.XtraEditors.TimeEdit , IABCControl , IABCBindableControl
    {
    ...
    public class ABCTimeEditDesigner : ControlDesigner
    {
        public ABCTimeEditDesigner ( )
        {
        }
    }
}
