...
{
    [ToolboxBitmapAttribute( typeof( DevExpress.XtraEditors.RichTextEdit ) )]
    [Designer( typeof( ABCRichTextEditDesigner ) )]
    public class ABCRichTextEdit : DevExpress.XtraEditors.RichTextEdit , IABCControl , IABCBindableControl
    {
    ...
    public class ABCRichTextEditDesigner : ControlDesigner
    {
        public ABCRichTextEditDesigner ( )
        {
        }
    }
}
