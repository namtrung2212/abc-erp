...
namespace ABCControls
{
    ...
    [Designer( typeof( ABCChartThreeSeriesControlDesigner ) )]
    public class ABCChartThreeSeriesControl : ABCChartBaseControl
    {
        public ABCChartBaseSeries MainSeries1;
        public ABCChartBaseSeries MainSeries2;
        public ABCChartBaseSeries MainSeries3;

        public ABCChartThreeSeriesControl ( )
        {
        ...
        public override void InitSeries ( )
        {
            ...
            MainSeries3.ColorEach=false;
        }

      
    }

    public class ABCChartThreeSeriesControlDesigner : ControlDesigner
    {
        public ABCChartThreeSeriesControlDesigner ( )
        {
        }
