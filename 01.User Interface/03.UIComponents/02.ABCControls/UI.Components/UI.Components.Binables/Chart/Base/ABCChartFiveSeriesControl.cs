...
namespace ABCControls
{
    ...
    [Designer( typeof( ABCChartFiveSeriesControlDesigner ) )]
    public class ABCChartFiveSeriesControl : ABCChartBaseControl
    {
        ...
        public ABCChartFiveSeriesControl ( )
        {
    ...
    public class ABCChartFiveSeriesControlDesigner : ControlDesigner
    {
        public ABCChartFiveSeriesControlDesigner ( )
        {
        }
