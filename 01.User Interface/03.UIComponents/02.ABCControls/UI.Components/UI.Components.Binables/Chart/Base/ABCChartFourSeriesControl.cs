...
namespace ABCControls
{
    ...
    [Designer( typeof( ABCChartFourSeriesControlDesigner ) )]
    public class ABCChartFourSeriesControl : ABCChartBaseControl
    {
        ...
        public ABCChartFourSeriesControl ( )
        {
        ...
        public override void InitSeries ( )
        {
            ...
            //DevExpress.XtraCharts.SeriesPoint seriesPoint7=new DevExpress.XtraCharts.SeriesPoint( "Tham số 1" , new object[] { ( (object)( 26D ) ) } , 0 );
            //DevExpress.XtraCharts.SeriesPoint seriesPoint8=new DevExpress.XtraCharts.SeriesPoint( "Tham số 2" , new object[] { ( (object)( 55D ) ) } , 1 );
            //DevExpress.XtraCharts.SeriesPoint seriesPoint9=new DevExpress.XtraCharts.SeriesPoint( "Tham số 3" , new object[] { ( (object)( 34D ) ) } , 2 );
            //DevExpress.XtraCharts.SeriesPoint seriesPoint10=new DevExpress.XtraCharts.SeriesPoint( "Tham số 1" , new object[] { ( (object)( 56D ) ) } , 0 );
            //DevExpress.XtraCharts.SeriesPoint seriesPoint11=new DevExpress.XtraCharts.SeriesPoint( "Tham số 2" , new object[] { ( (object)( 25D ) ) } , 1 );
            //DevExpress.XtraCharts.SeriesPoint seriesPoint12=new DevExpress.XtraCharts.SeriesPoint( "Tham số 3" , new object[] { ( (object)( 74D ) ) } , 2 );
            ...
            //MainSeries3.Points.AddRange( new DevExpress.XtraCharts.SeriesPoint[] { seriesPoint7 , seriesPoint8 , seriesPoint9 } );
            //MainSeries4.Points.AddRange( new DevExpress.XtraCharts.SeriesPoint[] { seriesPoint10 , seriesPoint11 , seriesPoint12 } );
        }

      
    }

    public class ABCChartFourSeriesControlDesigner : ControlDesigner
    {
        public ABCChartFourSeriesControlDesigner ( )
        {
        }
