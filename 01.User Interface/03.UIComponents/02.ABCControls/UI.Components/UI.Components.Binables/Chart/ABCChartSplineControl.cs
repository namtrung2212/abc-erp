...
namespace ABCControls
{
    ...
    [Designer( typeof( ABCChartSplineControlDesigner ) )]
    public class ABCChartSplineControl : ABCChartOneSeriesControl
    {

        public ABCChartSplineControl ( )
        {
        ...
        {
            MainSeries=new ABCChartSplineSeries( this );
    ...
    public class ABCChartSplineControlDesigner : ControlDesigner
    {
        public ABCChartSplineControlDesigner ( )
        {
        }
