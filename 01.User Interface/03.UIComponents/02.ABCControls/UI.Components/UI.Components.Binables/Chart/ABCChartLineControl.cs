...
namespace ABCControls
{
    ...
    [Designer( typeof( ABCChartLineControlDesigner ) )]
    public class ABCChartLineControl : ABCChartOneSeriesControl
    {

        public ABCChartLineControl ( )
        {
        ...
        {
            MainSeries=new ABCChartLineSeries( this );
    ...
    public class ABCChartLineControlDesigner : ControlDesigner
    {
        public ABCChartLineControlDesigner ( )
        {
        }
