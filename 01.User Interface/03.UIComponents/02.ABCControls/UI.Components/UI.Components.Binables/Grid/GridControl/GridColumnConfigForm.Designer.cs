namespace ABCControls
{
    partial class GridColumnConfigForm
    {
        ...
        private void InitializeComponent ( )
        {
            ...
            this.DisplayGridCtrl=new ABCControls.ABCBaseGridControl();
            this.DisplayGridView=new ABCControls.ABCGridView();
    ...
    //        this.gridColRepoType=new DevExpress.XtraGrid.Columns.GridColumn();
        ...
        private ABCControls.ABCBaseGridControl DisplayGridCtrl;
