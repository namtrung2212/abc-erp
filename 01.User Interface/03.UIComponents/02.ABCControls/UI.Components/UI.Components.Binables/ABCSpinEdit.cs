...
{
    [ToolboxBitmapAttribute( typeof( DevExpress.XtraEditors.SpinEdit ) )]
    [Designer( typeof( ABCSpinEditDesigner ) )]
    public class ABCSpinEdit : DevExpress.XtraEditors.SpinEdit , IABCControl , IABCBindableControl
    {
    ...
    public class ABCSpinEditDesigner : ControlDesigner
    {
        public ABCSpinEditDesigner ( )
        {
        }
    }
}
