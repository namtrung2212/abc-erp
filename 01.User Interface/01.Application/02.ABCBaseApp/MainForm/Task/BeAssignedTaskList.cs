...
namespace ABCApp
{
    ...
    public partial class BeAssignedTaskList : DevExpress.XtraEditors.XtraUserControl
    {
        ABCApp.MainForm mainForm;
        public bool SoundOn=true;

        public BeAssignedTaskList ( MainForm form )
        {
            mainForm=form;
        ...
        public void ReloadTasks ( )
        {
            ...
            DataSet ds=BusinessObjectController.RunQuery( String.Format( @"SELECT * FROM ADUserTasks WHERE ADUserTaskID IN ( SELECT FK_ADUserTaskID FROM ADUserTaskMembers,ADUsers WHERE FK_ADUserID =ADUserID AND ADUsers.No='{0}' GROUP BY FK_ADUserTaskID) ORDER BY CreateTime DESC" , ABCUserProvider.CurrentUserName ) );
